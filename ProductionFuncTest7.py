...
productions = [
    ...
    {
        'matches': {'buffer1': {}, 'buffer2': {'test': 'three'}},
    ...
    {
        'matches': {'buffer1': {}, 'buffer2': {'test': 'five'}},
        'negations': {'buffer1': {}, 'buffer2': {}},
        'utility': 10,
    ...
    {
        'matches': {'buffer1': {}, 'buffer2': {'test': 'six'}, 'buffer3': {'fruit': 'apple'}},
        'negations': {'buffer1': {}, 'buffer2': {}, 'buffer3': {}},
        'utility': 10,
