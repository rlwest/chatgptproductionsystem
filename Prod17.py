...
class ProductionCycle:
    ...
    def match_productions(self, buffers, AllProductionSystems):
        ...
        for prod_system_key, prod_system_value in AllProductionSystems.items():
            ...
            for production in prod_system:
                ...
                for buffer_key in production['matches'].keys():
                    ...
                    if not self.buffer_match_eval(buffers.get(buffer_key, {}), matches, negations):
    ...
    def execute_actions(self, buffers, matched_productions, AllProductionSystems, ProductionSystemDelays):
        ...
        self.filter_and_execute_productions(matched_productions, buffers, AllProductionSystems, ProductionSystemDelays)
...
for cycle_number in range(cycles):
    ...
    matched_productions = ps.match_productions(buffers, AllProductionSystems)  # Call as a method of the instance
