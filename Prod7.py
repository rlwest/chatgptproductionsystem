...
class ProductionSystem:
    ...
    def process_pending_actions(self, buffers, prodsys, original_delays):
    ...
    def filter_and_execute_productions(self, grouped_productions, buffers, prodsys, original_delays):
    ...
    def execute_actions(self, buffers, matched_productions, prodsys, original_delays):
        self.process_pending_actions(buffers, prodsys, original_delays)
        grouped_productions = self.group_matched_productions(matched_productions)
        self.filter_and_execute_productions(grouped_productions, buffers, prodsys, original_delays)
...
for cycle_number in range(cycles):
    ...
    ps.execute_actions(buffers, matched_productions, prodsys, original_delays)
